                        ...
                        {isAuthen ? (
                            <div className='content-requirement'>
                                ...
                                <div className='chose-shift-rq'>
                                    {jobDetail.shifts && jobDetail.shifts.map((item, index) => {
                                        return (<p key={index} className='require__p' style={{ margin: '10px 0px' }}>
                                            <Checkbox
                                                id={item.id}
                                        ...
                                        <div className='company-header'>
                                            <Row>
                                                <Col xs={4} sm={8} md={4} lg={3} xl={4} className='a_c'>
                                                    <Avatar size={70} shape={"square"} src={testImage(logoUrl, 'logo')} alt='logo-company' />
                                                    <JobType>
                                                        {jobDetail && jobDetail.jobType}
                                                    </JobType>
                                                </Col>
                                                ...
                                                <Col xs={24} sm={24} md={4} lg={4} xl={4} >
                                                    <Row className='btn-s-c'>
                                                        <Col xs={8} sm={8} md={24} lg={24} xl={24} style={{ marginTop: 10 }} >
                                                            <Button
                                                                size='large'
                                                                type={(isAuthen && !isSaved) ? 'primary' : 'ghost'}
                                                                onClick={() => this._saveJob()}
                                                                disabled={isSaved}
                                                                style={{
                                                                    marginRight: 5,
                                                                }}
                                                                children={(isAuthen && !isSaved) ? 'Lưu' : 'Đã lưu'}
                                                                block
                                                            />
                                                        </Col>
                                                        <Col xs={4} sm={4} md={4} lg={0} xl={0} className='a_c' ></Col>
                                                        <Col xs={12} sm={12} md={24} lg={24} xl={24} style={{ marginTop: 10 }} >
                                                            <Button
