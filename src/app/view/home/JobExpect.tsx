                ...
                <Row>
                    ...
                    <Col sm={24} md={12} lg={12} xl={12} xxl={12}>
                        <a href={`/result?brids=${2}`}>
                            <div className="expert-content">
                                ...
                                <LazyLoadImage style={{ width: '100%' }} src={Banner1} alt={"Công việc liên quan đến kinh doanh"} />
                    ...
                    <Col sm={24} md={12} lg={12} xl={12} xxl={12}>
                        <a href={`/result?brids=${13}`}>
                            <div className="expert-content">
                                <LazyLoadImage style={{ width: '100%' }} src={Banner2} alt={"Công việc liên quan đến kĩ thuật"} />
                                <div className="job-expert">
