      ...
      <div className="content-footer" style={{ display: props.disableFooterData ? "none" : "block" }}>
        <Row >
          ...
          <Col xs={24} sm={24} md={8} lg={8} className='rule'>
            <ul>
              <li><Icon type="right" /><a href='https://works.vn/'>Giới thiệu</a></li>
              <li><Icon type="right" /><a href='https://works.vn/privacy-policy/'>Điều khoản sử dụng</a></li>
              <li><Icon type="right" /><a href='https://works.vn/ve-chung-toi/'>Về chúng tôi</a></li>
            </ul>
          </Col>
          {/* Contact */}
