...
class SearchFilter extends React.Component<ISearchFilterProps, IStateSearchFilter> {
    constructor(props) {
        super(props);
        this.state = {
            jobType: null,
                ...
                <Row>
                    <Col xs={24} sm={24} md={12} lg={6} xl={6} xxl={6}>
                        <Select
                            ...
                            onChange={(event: string) => {
                                // console.log(event);
                                let newFilter = { jobType: null, regionID: this.state.regionID, jobNameID: this.state.jobNameID };
                    ...
                    <Col xs={24} sm={24} md={12} lg={6} xl={6} xxl={6}>
                        <Select
                            ...
                            showSearch
                            onChange={(event: string) => {
                                let newFilter = { regionID: null, jobType: this.state.jobType, jobNameID: this.state.jobNameID };
                                let region = regions && regions.filter((item) => event === item.id);
                                let regionID = null;
                    ...
                    <Col xs={24} sm={24} md={12} lg={8} xl={8} xxl={8}>
                        <Select
                            ...
                            showSearch
                            onChange={(event: string) => {
                                let newFilter = { jobNameID: null, jobType: this.state.jobType, regionID: this.state.regionID };
