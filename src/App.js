...
const ResetPassword = asyncComponent(() =>
  import('./app/view/reset-password/ResetPassword').then(module => module.default)
)
...
const HistoryApply = asyncComponent(() =>
  import('./app/view/history-apply/HistoryApply').then(module => module.default)
)
...
const DataJobNames = asyncComponent(() =>
  import('./app/view/data-job-names/DataJobNames').then(module => module.default)
)
        ...
        <Router>
          <Suspense fallback={<Loading />}>
            <Switch >
              ...
              <Route exact path="/tat-ca-cac-cong-viec" component={DataJobNames} />
