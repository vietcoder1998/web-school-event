export const REDUX = {
  ...
  JOB_RESULT: {
    ...
    SET_FILTER_MAJOR: "SET_FILTER_MAJOR",
    SET_JOB_TITLE: "SET_JOB_TITLE"
  },
  FIT_JOB: {
    GET_FIT_JOB: "GET_FIT_JOB",
    SET_LOADING_FIT_JOB: "SET_LOADING_FIT_JOB",
  },
  SAVED_JOB: {
  ...
  EMPLOYER: {
    GET_TOP_EM: "GET_TOP_EM",
    GET_SCHOOL_EVENT_EM: "GET_SCHOOL_EVENT_EM"
  },
  SCHOOLS: {
    GET_CONNECT_SCHOOL: "GET_CONNECT_SCHOOL"
  }
};
...
export const REDUX_SAGA = {
  ...
  EMPLOYER: {
    GET_TOP_EM: "GET_TOP_EM_DATA",
    GET_SCHOOL_EVENT_EM: "GET_SCHOOL_EVENT_EM_DATA"
  },
  SCHOOLS: {
    GET_CONNECT_SCHOOL: "GET_CONNECT_SCHOOL"
  },
